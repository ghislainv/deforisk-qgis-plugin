...
GPL version 3 license <license.html>`_. Anybody who is interested can contribute to
...
project’s `Code Of Conduct <code_of_conduct.html>`_.
...
please open an `issue <https://github.com/ghislainv/deforisk-qgis-plugin/issues>`_ on the GitHub project page.
...
Contribute to an Open Source Project on GitHub <https://egghead.io/courses/how-to-contribute-to-an-open-source-project-on-github>`_, Aaron Meurer’s
`tutorial on the git workflow <https://www.asmeurer.com/git-workflow/>`_, or the guide `How to Contribute to Open
Source <https://opensource.guide/how-to-contribute/>`_.
...
4. Commit the changes you made. Chris Beams has written a `guide <https://chris.beams.io/posts/git-commit/>`_ on how
