...
<qgis version="3.28.14-Firenze" styleCategories="Symbology">
  <renderer-v2 attr="fcc" type="categorizedSymbol" enableorderby="0" symbollevels="0" referencescale="-1" forceraster="0">
    ...
    <symbols>
      <symbol force_rhr="0" type="marker" frame_rate="10" alpha="1" is_animated="0" name="0" clip_to_extent="1">
      ...
      <symbol force_rhr="0" type="marker" frame_rate="10" alpha="1" is_animated="0" name="1" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" class="SimpleMarker" pass="0" enabled="1">
          <Option type="Map">
            <Option type="QString" value="0" name="angle"/>
            <Option type="QString" value="square" name="cap_style"/>
            <Option type="QString" value="34,139,34,255" name="color"/>
            <Option type="QString" value="1" name="horizontal_anchor_point"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="circle" name="name"/>
            <Option type="QString" value="0,0" name="offset"/>
